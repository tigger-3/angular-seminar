...
export class ButtonBildKommunikationService {
  ...
  getImageWithName(name: string): Bild{
    let bild = this.liste.find((bildToFilter)=>{return bildToFilter.name==name})
    return bild == undefined ? {name:"",src:""} : bild
  }
